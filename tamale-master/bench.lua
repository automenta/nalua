--
-- @file   bench.lua
-- @author Scott Vokes <silentbicyle@gmail.com>, António P. P. Almeida <appa@perusio.net>
-- @date   Fri Oct 16 13:27:10 2015
--
-- @brief  Benchmark for tamale.
--
--
--

local tamale = require 'tamale'
-- Required for socket.gettime.
...
local function timed(name, f, ct)
  ct = ct or DEF_CT
  local cpre = os.clock()
  for i = 1, ct do f() end
